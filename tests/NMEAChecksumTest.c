...
int main(int argc, char *argv[]) {
	...
	nmea_msg_t validCS = {
		...
		.raw = {0x43, 0x2c, 0x2c, 0x43, 0x2c, 0x45, 0x4e, 0x56, 0x5f,
			0x57, 0x41, 0x54, 0x45, 0x52, 0x5f, 0x54, 0x2c, 0x43, 0x2c,
			0x31, 0x36, 0x2e, 0x32, 0x34, 0x2c, 0x43, 0x2c, 0x45, 0x4e,
			0x56, 0x5f, 0x4f, 0x55, 0x54, 0x41, 0x49, 0x52, 0x5f, 0x54,
			0x2c, 0x50, 0x2c, 0x31, 0x30, 0x31, 0x38, 0x30, 0x30, 0x2c,
			0x50, 0x2c, 0x45, 0x4e, 0x56, 0x5f, 0x41, 0x54, 0x4d, 0x4f,
			0x53, 0x5f, 0x50}
	};
	validCS.checksum=0x61;

	nmea_msg_t invalidCS = {
		.encapsulated = false,
		.talker = "II",
		.message = "XDR",
		.rawlen = 62,
